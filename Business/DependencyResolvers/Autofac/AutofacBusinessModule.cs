...
{ 
    public class AutofacBusinessModule : Module
    {
        ...
        {
            builder.RegisterType<EmplyoeeManager>().As<IEmplyoeeService>().SingleInstance();
            builder.RegisterType<EfEmplyoeeDal>().As<IEmplyoeeDal>().SingleInstance();

            builder.RegisterType<PlantManager>().As<IPlantService>().SingleInstance();
            builder.RegisterType<EfPlantDal>().As<IPlantDal>().SingleInstance();
